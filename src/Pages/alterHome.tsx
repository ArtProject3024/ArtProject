    ...
    <div>
      <div className="relative h-[100vh] flex justify-center items-start">
        ...
        <div className="absolute inset-0 z-10">
          ...
          <Spline
            scene="https://prod.spline.design/IdWp1QuwRDlY9HPw/scene.splinecode"
            className="w-full h-full object-cover"
          />
        </div>
        ...
        <div className=" z-10 text-white w-full">
          ...
          <div className="w-full md:mt-10 px-10 text-center ">
            <h1 className="text-xl md:text-5xl mb-4 ">
              ...
              to learn more about <span className="font-bold ">
                AI tools{" "}
              </span>{" "}
              available
            </h1>
            ...
            <p className="text-base md:text-xl">
              Navigate groundbreaking possibilities and redefine your journey in
      ...
      <div id="feature">
        {selectedMainTitle ? (
          <div className="text-center pt-8 text-4xl font-bold" id="categories">
            AI Categories
          </div>
        ) : null}
